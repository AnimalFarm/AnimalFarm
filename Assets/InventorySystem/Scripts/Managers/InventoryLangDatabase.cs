...
{
    [System.Serializable]
    public class InventoryLangDatabase : ScriptableObject
    {
#if UNITY_EDITOR
        ...
        public InventoryNoticeMessage itemCannotBePickedUpToFarAway = new InventoryNoticeMessage("", "Item {0} is to far away to pick up", NoticeDuration.Medium, Color.white);
