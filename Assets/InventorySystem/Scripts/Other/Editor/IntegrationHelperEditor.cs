...
namespace Devdog.InventorySystem.Editors
{
    public class IntegrationHelperEditor : EditorWindow
    {
        ...
        [MenuItem("Tools/InventorySystem/Tools/Integrations")]
        public static void ShowWindow()
        {
            EditorWindow.GetWindow<IntegrationHelperEditor>("Integrations", true);
        }
        ...
        public void OnGUI()
        {
            ...
            ShowIntegration("UFPS (Ultimate FPS)", "Featuring the SMOOTHEST CONTROLS and the most POWERFUL FPS CAMERA available for Unity, Ultimate FPS is an awesome script pack for achieving that special AAA FPS feeling.", "https://www.assetstore.unity3d.com/en/#!/content/2943", "UFPS");
        ...
        private void ShowIntegration(string name, string description, string link, string defineName)
        {
            ...
            EditorGUILayout.LabelField(description, InventoryEditorUtil.labelStyle);
